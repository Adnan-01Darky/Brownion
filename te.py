...
st.write("Brownian Movement is said to be the random zig-zag motion of a particles.")
st.write(" We can  usually observed it under high power ultra-microscope.") 
st.write("Robert Brown explained this motion first time by the exact motion of pollen grains in water,")
st.write("hence, we call this motion Brownian motion.")
st.write("Some Real life examples of Brownion motion")


image = Image.open('br2.jpg')
st.image(image,caption='Diffusion of Pollutants in the Air')
image = Image.open('br.jpg')
st.image(image,caption='Movement of Dusk Particles')

image = Image.open('bo.gif')
st.image(image,caption='An gif image of brownian motion for understanding why there is random motion')
